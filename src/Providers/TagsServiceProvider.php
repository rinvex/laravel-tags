...
class TagsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishConfigFrom(realpath(__DIR__.'/../../config/config.php'), 'rinvex/tags');
        $this->publishMigrationsFrom(realpath(__DIR__.'/../../database/migrations'), 'rinvex/tags');

        ! $this->app['config']['rinvex.tags.autoload_migrations'] || $this->loadMigrationsFrom(realpath(__DIR__.'/../../database/migrations'));
